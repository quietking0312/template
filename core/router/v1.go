	...
	RouteGroups: []*define.RouteGroup{
		{
			...
			Path: "permission",
			Routes: []*define.Route{
				{Path: "", Method: http.MethodGet, Handler: v1.GetPermissionList, Title: "获取权限列表", PermissionId: 109901},
				...
				{Path: "user/permission", Method: http.MethodPost, Handler: v1.PostUserPermission, Title: "修改用户权限", PermissionId: 100005},
				...
				{Path: "role/permission", Method: http.MethodPost, Handler: v1.PostRolePermission, Title: "修改角色权限", PermissionId: 101005},
			},
		},
	},
}

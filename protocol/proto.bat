...
::pbjs -t static-module -w commonjs -o ../web/src/proto/message.js message.proto
pbjs -t json-module -w commonjs --es6 -o ../web/src/proto/message.js message.proto
:: pbts -o ../web/src/proto/message.d.ts ../web/src/proto/message.js
